...
const tools: Tool[] = [
  ...
  },
  {
    ...
    description:
      "Get coordinates and offices for a pincode (optionally filtered by office name).",
    inputSchema: {
      type: "object",
      properties: {
        pincode: { type: "string" },
    ...
    handler: (a) =>
      getCoordinates(
        String(a.pincode),
        a.officeName ? String(a.officeName) : undefined,
      ),
  },
  {
    name: "get_by_state",
  ...
  },
  {
    ...
    inputSchema: {
      type: "object",
      properties: { district: { type: "string" }, limit: { type: "number" } },
      required: ["district"],
    },
    handler: (a) =>
      getByDistrict(String(a.district), { limit: a.limit as number }),
  },
  {
    name: "search_offices",
    ...
    handler: (a) =>
      searchOffices(String(a.query), { limit: a.limit as number }),
  },
  {
  ...
  },
  {
    ...
    inputSchema: {
      type: "object",
      properties: { pincode: { type: "string" }, radiusKm: { type: "number" } },
      required: ["pincode", "radiusKm"],
    },
  ...
  },
  {
    ...
    description:
      "Check whether a string is a syntactically valid Indian pincode.",
    inputSchema: {
      type: "object",
      properties: { pincode: { type: "string" } },
      required: ["pincode"],
  ...
  },
  {
    ...
    description:
      "Return state, district, GST code, region, tier, and offices for a pincode (form auto-fill).",
    inputSchema: {
      type: "object",
      properties: { pincode: { type: "string" } },
      required: ["pincode"],
  ...
  },
  {
    name: "shipping_zone",
    description:
      "Classify a from/to pincode pair into a courier shipping zone.",
    inputSchema: {
      type: "object",
      properties: { from: { type: "string" }, to: { type: "string" } },
      required: ["from", "to"],
  ...
  },
  {
    ...
    handler: (a) =>
      estimateDeliveryDays(String(a.from), String(a.to), {
        speedFactor: a.speedFactor as number,
      }),
  },
  {
    name: "state_gst_code",
  ...
  },
  {
    name: "state_meta",
    description:
      "Full metadata for a state (GST code, ISO, local name, capital, region).",
    inputSchema: {
      type: "object",
      properties: { state: { type: "string" } },
      required: ["state"],
  ...
  },
  {
    ...
    handler: (a) =>
      suggestPincodes(String(a.prefix), (a.limit as number) ?? 10),
  },
];
  ...
  try {
    switch (method) {
      ...
      case "tools/call": {
        ...
        const args = ((params as Record<string, JsonValue>)?.arguments ??
